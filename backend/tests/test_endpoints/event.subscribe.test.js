...
// DESCRIBE
.then(function() {
    log.test.describe('Validates no ID sent');
})
...
.then(function() {
    return new Promise(function(resolve, reject) {
        ...
        suite
            ...
            .expect('Requires event ID', function(err, res, body) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        suite
            ...
            .expect('Gets success message for subscription', function(err, res, body) {
                utilities.hasSuccessMessage(err, res, body, 'User is now attending event');
            })
            .export(module);
