describe('chartService', function() {
    ...
    describe('blank series', function() {
        ...
        it('throws Error if no parameter passed', function() {
            expect(chartService.blankSeries)
                .toThrow();
        });

        it('Returns array', function() {
            expect(chartService.blankSeries(1))
                .toEqual(['']);
            expect(chartService.blankSeries(2))
                .toEqual(['', '']);
            expect(chartService.blankSeries(5))
                .toEqual(['', '', '', '', '']);
        });
    ...
    describe('formatErrors', function() {
        ...
        it('throws Error if no parameter passed', function() {
            expect(chartService.formatErrors)
                .toThrow();
        });

        it('throws Error if parameter is not object', function() {

            expect(function() {
                    chartService.formatErrors([]);
                })
                .toThrow();
